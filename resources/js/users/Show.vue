<template>
    <div class="flex flex-col items-center" v-if="status.user === 'success'">
        ...
        <div v-else-if="user" class="relative mb-8">
            ...
            <div
                class="absolute bottom-0 left-0 ml-12 -mb-8 z-20 flex items-center"
            >
                <div class="w-32">
                    <UploadableImage
                        image-width="800"
            ...
            <div
                class="absolute bottom-0 right-0 mr-12 mb-4 z-20 flex items-center"
            >
                <button
        ...
        <div v-else-if="status.posts === 'success' && posts.length < 1">
            No posts found.
        </div>
        <template v-if="posts">
            <Post
