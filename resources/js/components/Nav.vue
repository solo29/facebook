      ...
      <div class="flex">
        ...
        <div class="ml-2 relative">
          ...
          <input
            type="text"
            name="search"
            class="w-56 bg-gray-200 h-8 rounded-full text-sm pl-8 focus:outline-none focus:shadow-outline"
            placeholder="Search Facebook"
          />
        </div>
      </div>
    </div>
    <div class="w-1/3 flex items-center justify-center h-full" v-if="authUserStatus">
      <router-link to="/" class="px-6 border-white border-b-2 h-full flex items-center">
      ...
      <router-link
        ...
        class="px-6 border-white border-b-2 h-full flex items-center"
      >
        <img
...
export default {
  name: "Nav",
  computed: {
    ...mapGetters(["authUser", "authUserStatus"])
  }
};
</script>
